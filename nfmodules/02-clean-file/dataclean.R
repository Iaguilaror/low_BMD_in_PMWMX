...
# args[1] <- "OP_Vs_OPI.xlsx" ## "test/data/OP_Vs_Normal.xlsxf"
...
data_toda <- read.xlsx( xlsxFile = ifile, sheet = 1 )
...
# Calculamos valores de interes para las inyecciones de la condicion 2
